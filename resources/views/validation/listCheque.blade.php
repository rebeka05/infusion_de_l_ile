...
<form action="{{ route('filtreCheque') }}" method="get">
@csrf
                    ...
                    <tbody>
                        ...
                        <td class="text-center">
                          @if ($cheque->dateversement == null)
                            <a class="mt-3 btn bg-gradient-primary" href="{{ route('modifCheque', [ 'id' => $cheque->idpaiement ]) }}">verser</a>
                          @endif
                          @if ($cheque->dateversement != null)
                            <a class="mt-3 btn bg-gradient-primary" href="{{ route('modifCheque', [ 'id' => $cheque->idpaiement ]) }}">disponible</a>
                          @endif
                        </td>
                        </tr>
                        @endforeach
